...
function ShowState(json){
	...
	var textForm = React.createClass({
		render: function(){
			return(React.createElement("form",{action: "http://localhost:8080/",
											   method: "post",
											   encType: "multipart/form-data"},
					 React.createElement("label", {htmlFor: "text"}, "Say Something:"),
	...
	var fileForm = React.createClass({
		render: function(){
			return(React.createElement("form",{action: "http://localhost:8080/",
											   method: "post",
											   encType: "multipart/form-data"},
					 React.createElement("label", {htmlFor: "file"}, "Filename:"),
